...
HER_ENV_LIST = {"FlipBit4", "FlipBit8", "FlipBit16", "FlipBit32", "FlipBit48", "EmptyMaze", "FourRoomMaze", "FetchPushDiscrete",
                "FetchReachDiscrete", "FetchSlideDiscrete", "MsPacman"}
my_own_envs = {"BaxterReacher-v0", "FlipBit4", "FlipBit8", "FlipBit16", "FlipBit32", "FlipBit48", "EmptyMaze", "FourRoomMaze",
...
def build_env(args):
    ...
    if env_type in {'atari'}:
        ...
        # TODO: What is this for if never used?
        flatten_dict_observations = alg not in {'VPG', 'NPG', 'TRPO', 'HPG', 'HTRPO', 'ReFER'}
